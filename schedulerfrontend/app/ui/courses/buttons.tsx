...
export function UpdateCourse({ course_id }: { course_id: number }) {
  return (
    <Link
...
export function DeleteCourse({ course_id }: { course_id: number }) {
  const deleteCourseWithId = deleteCourseAction.bind(null, course_id);
